...
namespace KS.SceneFusion.Extensions.Editor
{
    ...
    public class Ferr2DExtension
    {
        ...
        static Ferr2DExtension()
        {
            ...
            // Sync hidden properties m_SortingLayerID and m_SortingOrder on MeshRenderers
            sfUtility.SyncHiddenProperties<MeshRenderer>("m_SortingLayerID", "m_SortingOrder");
